...
import { verifyUnit } from "@/components/form/form-utils";
        ...
        uploadImg: async function () {
            ...
            new Promise((resolve, reject) => {
                ...
                uni.getImageInfo({
                    ...
                    if (res.width < this.screen.width && res.height < this.screen.height)
                        resolve(file);
