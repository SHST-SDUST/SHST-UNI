<template>
    <view>
        <detail mine :post="post" :review="review" @save-post="savePost" @save-review="saveReview">
...
export default {
    ...
    onLoad: function (option) {
        if (option.id) {
            uni.$app.onload(async () => {
                ...
                this.post.imgs = res.data.detail.img_url
    ...
    methods: {
        edit: function () {
            ...
            uni.$app.data.tmp.post.imgs = this.post.imgs.map(
                v => this.post.host + "public/upload/" + v
            );
