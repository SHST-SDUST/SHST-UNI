<template>
    <view>
                ...
                <scroll-view scroll-x class="x-full">
                    <view class="a-flex">
                        ...
                        >
                            ...
                            <view
                                class="tab-font"
                                :class="{ 'tab-active-font': activeIndex === item.index }"
                            >
                                {{ item.name }}
                            </view>
                            <view
                                class="tab-line"
                                :class="{ 'tab-active': activeIndex === item.index }"
                            ></view>
                        </view>
                    </view>
                </scroll-view>
        ...
        <view
            class="new-post-container x-center y-center"
            @click="checkNav('/pages/sdust/news/new-post/new-post')"
        >
...
<script>
import { registerCheck } from "@/vector/pub-fct";
