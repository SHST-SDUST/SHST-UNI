    ...
    <view>
        <view v-if="list.length">
                ...
                <layout>
                    <view class="y-center a-flex-space-between">
                        <view class="y-center">
                            ...
                            <view class="a-ml a-pl a-color-blue">
                                {{ item.user_type | userFilter }}
                            </view>
                        </view>
                    </view>
                    <view class="a-lmt" @click="$emit('jump', item.id)">
                        <view>
                            <view>
                                ...
                                <view class="a-lmt a-lmt a-fontsize-13 a-color-grey tips-con">
                                    {{ item.content }}
                                </view>
                            </view>
            ...
            <layout>
                <loading
                    :loading="loadStatus"
                    @click="this.$emit('loadNext', activeIndex, page + 1)"
                ></loading>
            </layout>
        </view>
        <layout v-else>
