    ...
    <view>
        <layout title="嵙地图">
            <view style="position: relative">
                <image
                    src="http://wx4.sinaimg.cn/large/007U8ryUly1g5h4dl25bvj318g0u0b29.jpg"
                    class="sdust-map"
                    mode="widthFix"
                    @click="
                        viewImg('http://wx4.sinaimg.cn/large/007U8ryUly1g5h4dl25bvj318g0u0b29.jpg')
                    "
                ></image>
        ...
        <layout title="在线地图">
            <view class="tips">
                <view :style="{ background: point }" class="a-dot"></view>
