    ...
    <view>
        <view>
            <scroll-view scroll-x="true">
                <view v-if="!fullscreen" class="top-swich text-center">
                    <label
                        v-for="(item, index) in buildlData"
                        :id="index"
                        :key="index"
            ...
            >
                <view
                    v-for="(item, index) in buildlData[isSelectedBuildType].data"
                    :key="index"
                    class="building-item"
                    ...
                    <view class="img-view">
                        ...
                        >
                            ...
                            <view class="item">
                                ...
                                <view v-if="item.floor" class="item-floor">
                                    位置：{{ item.floor }}
                                </view>
                            </view>
                        </navigator>
