        ...
        <layout>
            <view class="">
                <view class="a-input-con-line a-lmb">
                    ...
                    <input v-model="className" class="a-input" placeholder="请输入(可选)" />
                </view>
                <view class="a-input-con-line a-lmb">
                    <view class="a-label">教师名:</view>
                    <input v-model="teacherName" class="a-input" placeholder="请输入(可选)" />
                </view>
...
export default {
    ...
    computed: {
        computedClasses: function () {
            ...
            const startClass = ["01-02节", "03-04节", "05-06节", "07-08节", "09-10节"];
            return this.classes.map(v => {
                ...
                v.classWeek =
                    ~~(
                        util.dayDiff(
                            uni.$app.data.curTermStart,
                            util.formatDate(void 0, util.safeDate(v.date_start))
                        ) / 7
                    ) + 1;
                return v;
            });
