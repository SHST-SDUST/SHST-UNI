        ...
        <layout title="共享课表">
            ...
            <view v-if="data.status === 0">
                            ...
                            >
                                <view
                                    v-if="
                                        ...
                                        data.succ.timeTable2[inner][item]
                                    "
                                    class="timetable-hide-bot"
                                    style="background: rgb(100, 149, 237)"
                                >
                                    <view
                                        v-for="(classObj, classIndex) in data.succ.timeTable2[
                                            inner
                                        ][item].table"
                                        :key="classIndex"
                                    >
                                        ...
                                        <view
                                            v-if="
                                                classIndex !==
                                                data.succ.timeTable2[inner][item].table.length - 1
                                            "
                                        >
                                            ---
                                        </view>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <view
                                            v-if="
                                                classIndex !==
                                                data.succ.timeTable1[inner][item].table.length - 1
                                            "
                                        >
                                            ---
                                        </view>
                ...
                <view class="y-center">
                    ...
                    <view class="a-btn a-btn-blue a-btn-small" @click="lifting(data.succ.id)">
                        解除关系
                    </view>
                </view>
            </view>
    ...
    methods: {
        onloadData: async function () {
            ...
            if (res.data.info.succ) {
                const succData = res.data.info.succ;
